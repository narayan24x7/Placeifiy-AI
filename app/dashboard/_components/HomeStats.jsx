      ...
      <div className="p-14 grid md:grid-cols-2 gap-5">
        <div className="rounded-lg border-4 border-gray-100 bg-white p-4 shadow-sm transition hover:shadow-lg sm:p-6">
          <div className="text-lg my-4 font-semibold">
            <label className="bg-blue-500 pl-3 pr-3 p-2 rounded-full text-white">
              Step - 1
            </label>
          </div>
          <div className="md:p-1 lg:p-1 sm:p-0">
            ...
            <a
              href="#"
              className="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-pink-700"
            >
              Find out more
              <span
                aria-hidden="true"
        ...
        <div className="rounded-lg border-4 border-gray-100 bg-white p-4 shadow-sm transition hover:shadow-lg sm:p-6">
          ...
          <div className="md:p-1 lg:p-1 sm:p-0">
            <a href="#">
              <h3 className="text-lg text-pink-700 font-semibold">
        ...
        <div className="rounded-lg border-4 border-gray-100 bg-white p-4 shadow-sm transition hover:shadow-lg sm:p-6">
          ...
          <div className="md:p-1 lg:p-1 sm:p-0">
            <a href="#">
              <h3 className="mt-0.5 text-lg font-semibold text-pink-700">
